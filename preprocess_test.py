"""Script to preprocess test data from SQLite database."""
...
def main():
    ...
    print_header("🔧 Test Data Preprocessing")
    ...
    if not db_path.exists():
        ...
        print_info("Please run 'python import_test.py' first to import data")
        return
    ...
    try:
        ...
        if table_name not in available_tables:
            ...
            print_info(
                f"\nPlease run 'python import_test.py' first to create "
