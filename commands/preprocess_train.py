"""Command to preprocess training data from SQLite database."""
...
def preprocess_train_command() -> None:
    """
    Command-line command to preprocess training data from SQLite database.

    Usage:
        python -m commands.preprocess_train
        python -m commands.preprocess_train --db data/train.db --table train_data
    """
    parser = argparse.ArgumentParser(
        description="Preprocess training data from SQLite database",
    ...
    parser.add_argument(
        ...
        type=str,
        default="train_data",
        help="Name of the table to read from (default: train_data)",
    )
    ...
    # Save to database
    print(f"\nSaving preprocessed training data to database: {db_path}")
